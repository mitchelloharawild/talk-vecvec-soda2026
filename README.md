...
4.  Mixed type vectors of vectors. A brief showcase of the vecvec
    package.
5.  Operations on semantic vectors with the distributional package.
6.  Other semantic vectors (mixtime, graphvec, sf).
7.  Combining semantic variables (distributional+mixtime == forecasts).
8.  Interoperability between semantic vectors (ivs, temporal
    uncertainty, …).
