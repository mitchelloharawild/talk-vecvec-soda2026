...
Slides and notes for a presentation about vectorised statistics at LMU
SODA in Munich, Germany (May 2026).
...
6.  Mixed type vectors of vectors. A brief showcase of the vecvec
    package.
...
10. Interoperability between semantic vectors (ivs, temporal
    uncertainty, …).
