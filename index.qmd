...
::: columns
::: {.column width="37.5%"}
![](resources/lmu.svg){.diffused-bg style="margin: 470px 0 0 -48px"}
:::
::: {.column width="60%"}
...
![](resources/projector-screen-outline.svg){.icon} [slides.mitchelloharawild.com/soda2026](https://slides.mitchelloharawild.com/soda2026)

![](resources/github.svg){.icon} [mitchelloharawild/talk-vecvec-soda2026](https://github.com/mitchelloharawild/talk-vecvec-soda2026)
...
[[(Meta)]{.fragment} Motivation]{style="font-size: 5em;"}
...
![](media/interests-1.svg){.image-left}

![](media/interests-2.svg){.image-left .fragment fragment-index=1}

![](media/interests-3.svg){.image-left .fragment fragment-index=4}

![](media/interests-4.svg){.image-left .fragment fragment-index=5}

![](media/interests-5.svg){.image-left .fragment fragment-index=6}

![](media/interests-6.svg){.image-left .fragment fragment-index=12}

![](media/interests-7.svg){.image-left .fragment fragment-index=15}

![](media/interests-8.svg){.image-left .fragment fragment-index=17}

![](media/interests-9.svg){.image-left .fragment fragment-index=18}

![](media/interests-a.svg){.image-left .fragment fragment-index=19}

![](media/interests-b.svg){.image-left .fragment fragment-index=22}

![](media/interests-c.svg){.image-left .fragment fragment-index=24}
...
![](media/hobby/chicks.jpeg){.fragment fragment-index=1}

![](media/hobby/hens.jpeg){.fragment fragment-index=2}

![](media/hobby/eggs.jpeg){.fragment fragment-index=3}

![](media/hobby/compost.jpeg){.fragment fragment-index=4}

![](media/hobby/pumpkin.jpeg){.fragment fragment-index=5}

![](media/hobby/beehives.jpg){.fragment fragment-index=6}

![](media/hobby/honey-frame.jpg){.fragment fragment-index=7}

```{=html}
<video class="fragment" data-fragment-index=8 muted loop>
  <source src="media/hobby/honey-extract.mp4" type="video/webm">
</video>
```

```{=html}
<video class="fragment" data-fragment-index=9 muted loop>
  <source src="media/hobby/honey-filter.mp4" type="video/webm">
</video>
```

```{=html}
<video class="fragment" data-fragment-index=10 muted loop>
  <source src="media/hobby/honey-bucket.mp4" type="video/webm">
</video>
```

![](media/hobby/honey-jar.jpeg){.fragment fragment-index=11}

![](media/hobby/mush-bucket.jpeg){.fragment fragment-index=12}

![](media/hobby/mush-pink-oyster.jpeg){.fragment fragment-index=13}

![](media/hobby/mush-tent.jpeg){.fragment fragment-index=14}

![](media/hobby/mush-pcb.png){.fragment fragment-index=15}

![](media/hobby/oshw-dendrometer.png){.fragment fragment-index=16}

![](media/rpkgs.svg){.fragment fragment-index=17}

![](media/hobby/bike.jpeg){.fragment fragment-index=18}

![](media/hobby/hike-forest.jpg){.fragment fragment-index=19}

![](media/hobby/hike-view.jpg){.fragment fragment-index=20}

![](media/hobby/hike-milo.jpg){.fragment fragment-index=21}

![](media/hobby/game-wingspan.jpeg){.fragment fragment-index=22}

![](media/hobby/game-schafkopf.jpg){.fragment fragment-index=23}
:::
...
* 📚 Better data (structures) makes for better models.
* ⛰️ Let's go on a hike! Any suggestions?
* 🃏 Board games next week? Schafkopf? 😁
