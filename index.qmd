...
![](media/interests.svg){.image-left}
...
::: {.r-stack}
![](media/hobby/chicks.jpeg){.fragment}

![](media/hobby/hens.jpeg){.fragment}

![](media/hobby/eggs.jpeg){.fragment}

![](media/hobby/compost.jpeg){.fragment}

![](media/hobby/pumpkin.jpeg){.fragment}

![](media/hobby/beehives.jpg){.fragment}

![](media/hobby/honey-frame.jpg){.fragment}

```{=html}
<video class="fragment" muted loop>
...
![](media/hobby/honey-jar.jpeg){.fragment}

![](media/hobby/mush-bucket.jpeg){.fragment}

![](media/hobby/mush-pink-oyster.jpeg){.fragment}

![](media/hobby/mush-tent.jpeg){.fragment}

![](media/hobby/mush-pcb.png){.fragment}

![](media/hobby/oshw-dendrometer.png){.fragment}

![](media/rpkgs.svg){.fragment}

![](media/hobby/bike.jpeg){.fragment}

![](media/hobby/hike-forest.jpg){.fragment}

![](media/hobby/hike-view.jpg){.fragment}

![](media/hobby/hike-milo.jpg){.fragment}

![](media/hobby/game-wingspan.jpeg){.fragment}

![](media/hobby/game-schafkopf.jpg){.fragment}
:::
